...
class Encomiendascreen extends StatelessWidget {
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                _buildOptionCard(
                  ...
                  description:
                      'Crea un nuevo envío de paquetes de forma rápida y segura',
                  features: [
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const RemitenteScreen(),
                      ),
                    );
                  },
                ),
                ...
                _buildOptionCard(
                  ...
                  description:
                      'Consulta el estado actual de tus paquetes en tránsito',
                  features: [
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const RastreoEncomiendaScreen(),
                      ),
                    );
                  },
                ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Envía y rastrea tus paquetes de manera fácil y confiable',
                style: TextStyle(
                  fontSize: 14,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoStep(
            ...
            description: 'Ingresa los datos del paquete y destino',
          ...
          _buildInfoStep(
            ...
            description: 'Confirma el monto y método de pago',
          ...
          _buildInfoStep(
            ...
            description: 'Monitorea el estado en tiempo real',
