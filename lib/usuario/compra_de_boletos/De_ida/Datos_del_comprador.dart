...
class DatosCompradorScreen extends StatefulWidget {
  final String busId;
  ...
  @override
  _DatosCompradorScreenState createState() => _DatosCompradorScreenState();
}

class _DatosCompradorScreenState extends State<DatosCompradorScreen>
