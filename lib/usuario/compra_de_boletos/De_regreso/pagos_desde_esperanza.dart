...
class PagoScreen2 extends StatefulWidget {
  final String busId;
  ...
  @override
  _PagoScreen2State createState() => _PagoScreen2State();
}

class _PagoScreen2State extends State<PagoScreen2>
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _buildDatoBancario('Número de Cuenta', '2214150854'),
                      const SizedBox(height: 12),
                      _buildDatoBancario('Titular', 'Lima Chamba'),
                      const SizedBox(height: 12),
                      _buildDatoBancario('Cedula', '0402174965'),
                    ],
                  ),
                ),
                const SizedBox(height: 16),
